...
func RegisterRoutes(b *bot.Bot) {
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "plan", bot.MatchTypeCommand, handlers.HandlePlan)
	...
	b.RegisterHandler(bot.HandlerTypeMessageText, "links", bot.MatchTypeCommand, handlers.HandleLinks)
	b.RegisterHandler(bot.HandlerTypeMessageText, prefix+" links", bot.MatchTypePrefix, handlers.HandleLinks)

	b.RegisterHandler(bot.HandlerTypeMessageText, "contribuir", bot.MatchTypeCommand, handlers.HandleContribuir)
	b.RegisterHandler(bot.HandlerTypeMessageText, prefix+" contribuir", bot.MatchTypePrefix, handlers.HandleContribuir)

	b.RegisterHandler(bot.HandlerTypeMessageText, "materias", bot.MatchTypeCommand, handlers.HandleMaterias)
}
